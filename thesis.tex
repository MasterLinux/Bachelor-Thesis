...
When a new project has to be created, the current opened project is closed and an empty project without any Java file is created. This project has the typical folder structure, which is described above \ref{folder_structure}. To create a new project the start menu entry "New Project" is used.
